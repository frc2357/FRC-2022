...
public class AutoStartShotCommand extends ParallelCommandGroup{
    double m_time;


    public AutoStartShotCommand() {
        addCommands(new ShootAutoStartCommand());
   ...
   public boolean isFinished() {
        return super.isFinished() || m_time < System.currentTimeMillis();
    }
