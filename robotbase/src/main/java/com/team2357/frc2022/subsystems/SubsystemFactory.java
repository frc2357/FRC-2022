...
public class SubsystemFactory {
    ...
    public IntakeSubsystem CreateIntakeSubsystem(ArduinoSensorState state) {
        ...
        return new IntakeSubsystem(intakeVictor, intakeDoubleSolenoid, state);
    }

    public FeederSubsystem CreateFeederSubsystem(ArduinoSensorState state) {
        WPI_TalonSRX feederTalon = new WPI_TalonSRX((Constants.CAN_ID.FEEDER_MOTOR_ID));
        return new FeederSubsystem(feederTalon, state);
    }
